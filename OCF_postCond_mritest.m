...
cgtext('followed by unpleasant pic/sound',0,0*ScrHgh/6 - 15);
 cgtext('Yellow-increase, Blue-decrease',0,-0.6*ScrHgh/6 - 15);
cgtext('Green-confirm',0,-1.2*ScrHgh/6 - 15);
%cgtext('Green-confirm',0,-1.8 * ScrHgh/6 - 15);
cgflip
